            ...
            <div class="col-12">
                ...
                <div class="card card-primary mt-2">
                    <div class="ribbon-wrapper ribbon-xl">
                        ...
                        <?php switch($pengajuan_penundaan[0]->status):
                        case ('tolak'): ?>
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <p class="card-text">
                                    <?php echo e($pengajuan_penundaan[0]->tanggal); ?>
                            ...
                            <div class="form-group">
                                ...
                                <p class="card-text">
                                    <?php echo e($pengajuan_penundaan[0]->name); ?>
                            ...
                            <div class="form-group">
                                ...
                                <p class="card-text">
                                    <?php echo e($pengajuan_penundaan[0]->keterangan); ?>
                            ...
                            <div class="form-group">
                                <label for="keterangan" class="text-center">Pengajuan ini memenuhi syarat untuk melakukan penundaan biaya</label>
                                <p class="card-text">
                                </p>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <!-- /.card-body -->
                            <?php if(DB::table('request_postpone_agreement')->where([['id', '=', $pengajuan_penundaan[0]->id], ['status', '!=', 'setuju']])->count() == 1): ?>
                            ...
                            <?php if($pengajuan_penundaan[0]->status == 'tolak'): ?>
                            <?php else: ?>

                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if(DB::table('laporan_dana_proses')->where([['id', '=', $pengajuan_penundaan[0]->id], ['status', '!=', 'setuju'], ['dikonfirmasi', '=', null]])->count() == 1): ?>
                            <!-- <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
                        ...
                        <div class="card-footer">
                            ...
                            <?php if($pengajuan_penundaan[0]->status == 'setuju'): ?>
                            <!-- <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
                            ...
                            <?php if($pengajuan_penundaan[0]->status == 'setuju' && !$pengajuan_penundaan[0]->dikonfirmasi == 'TU'): ?>
                            <!-- <div class="card-footer">
                            <button type="submit" class="btn btn-block btn-primary" name="action">Konfirmasikan ke wadek 1</button>
                        </div> -->
                            <?php endif; ?>
                            <?php endif; ?>
                            <?php if(DB::table('expedisi')->where('id', '=', $pengajuan_penundaan[0]->id)->count() == 1 &&
                            ...
                            <?php endif; ?>
                            <?php if(DB::table('laporan_dana_proses')->where([['id', '=', $pengajuan_penundaan[0]->id],['status', '=', 'setuju'], ['disetujui', '=', 'Wadek']])->count() == 1): ?>
                            <!-- <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('component.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\latihan_laravel\laravel-maulana\resources\views/component/tu/preview_setuju.blade.php ENDPATH**/ ?>