                        ...
                        <form method="POST" enctype="multipart/form-data" id="formAdd">
                            ...
                            <div class="card-body mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <ol start="1">
                                        <li>
                                            <input type="text" name="jumlah_cicilan[]" class="form-control" id="jumlah_cicilan" value="<?php echo e($hutang/2); ?>"  disabled>
                                        </li>
                                        
                                    <?php for($i = 1; $i < $cicilan; $i++): ?> 
                                        <li>
                                            <input type="text" name="jumlah_cicilan[]" class="form-control" id="jumlah_cicilan" placeholder="Cicilan Ke-<?php echo e($i+1); ?>" required>
                                        </li>
                                    <?php endfor; ?>
                                    </ol>
                                </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" id="submit_user" class="btn btn-primary">Cetak PDF</button>
                                    <a href="<?php echo e(route('requestPostponeAgreementAgree',['parent_id' => $parent_id ])); ?>" class="btn btn-primary" type="submit" target="_blank" >Ajukan Penundaan Biaya Kuliah</a>
                                </div>
...
<?php echo $__env->make('component.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Acer\Documents\laravel-maulana\laravel-maulana\resources\views/user/add.blade.php ENDPATH**/ ?>