                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tanggal_penyelenggara" class="form-control" id="tanggal_penyelenggara" value="">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-block btn-primary" name="action">Meneruskan
                                ke wadek 1</button>
                        </div>
                        <?php endif; ?>
                        <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('component.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\latihan_laravel\laravel-maulana\resources\views/component/tu/preview.blade.php ENDPATH**/ ?>