                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" value="<?php echo e($pengajuan_dana[0]->tanggal); ?>" class="form-control" id="tanggal" value="<?php echo e(date('Y-m-d')); ?>" disabled>
                            </div>
                            <!-- <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('component.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\latihan_laravel\laravel-maulana\resources\views/component/wadek/preview_tolak.blade.php ENDPATH**/ ?>