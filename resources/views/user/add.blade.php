                        ...
                        <form method="POST" enctype="multipart/form-data" id="formAdd">
                            ...
                            <div class="card-body mt-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <ol start="1">
                                        <li>
                                            <input type="text" name="jumlah_cicilan[]" class="form-control" id="jumlah_cicilan" value="{{$hutang/2}}"  disabled>
                                        </li>
                                        
                                    @for ($i = 1; $i < $cicilan; $i++) 
                                        <li>
                                            <input type="text" name="jumlah_cicilan[]" class="form-control" id="jumlah_cicilan" placeholder="Cicilan Ke-{{$i+1}}" required>
                                        </li>
                                    @endfor
                                    </ol>
                                </div>
                                ...
                                <div class="card-footer">
                                    ...
                                    <a href="{{ route('requestPostponeAgreementAgree',['parent_id' => $parent_id ]) }}" class="btn btn-primary" type="submit" target="_blank" >Ajukan Penundaan Biaya Kuliah</a>
                                </div>
