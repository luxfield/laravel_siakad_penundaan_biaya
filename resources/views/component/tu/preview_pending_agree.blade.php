                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="keterangan" class="form-control" id="keterangan" value="{{-- $pengajuan_dana[0]->keterangan_persetujuan --}}" required>
                            </div>
                            <div class="form-group">
                        ...
                        <!-- /.card-body -->
                        @if (DB::table('request_postpone_agreement')->where([['id', '=', $pengajuan_dana[0]->id], ['status', '!=', 'setuju']])->count() == 1)
                        ...
                        @if ($pengajuan_dana[0]->status == 'tolak')
                        @else

                        @endif
                        @endif
                        @if (DB::table('laporan_dana_proses')->where([['id', '=', $pengajuan_dana[0]->id], ['status', '!=', 'setuju'], ['dikonfirmasi', '=', null]])->count() == 1)
                        <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
                        ...
                        @if ($pengajuan_dana[0]->status == 'setuju')
                        <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
                        ...
                        @if ($pengajuan_dana[0]->status == 'setuju' && !$pengajuan_dana[0]->dikonfirmasi == 'TU')
                        <div class="card-footer">
                            <button type="submit" class="btn btn-block btn-primary" name="action">Konfirmasikan ke wadek 1</button>
                        </div>
                        @endif
                        @endif
                        @if (DB::table('expedisi')->where('id', '=', $pengajuan_dana[0]->id)->count() == 1 &&
                        ...
                        @endif
                        @if (DB::table('laporan_dana_proses')->where([['id', '=', $pengajuan_dana[0]->id],['status', '=', 'setuju'], ['disetujui', '=', 'Wadek']])->count() == 1)
                        <div class="row justify-content-center">
                            <div class="col">
                            </div>
                            <div class="col">
