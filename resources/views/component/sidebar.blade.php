  ...
  <div class="sidebar">
    ...
    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
      ...
      <div class="info">
        ...
        <a href="{{ route('editProfile')}}" class="d-block">{{ $pengguna }}</a>
        @else
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        @if (Session::get("user") != "HMJ" && Session::get("user") == "KAPRODI" || Session::get("user") == "DOSEN" )
        ...
        <li class="nav-item">
          ...
          <ul class="nav nav-treeview">
            <li class="nav-item">
              <a href="{{ route('ajukan laporan') }}" class="nav-link">
                {{-- <i class="far fa-circle nav-icon"></i> --}}
                <p>Buat Laporan penggunaan dana</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('laporan disetujui') }}" class="nav-link">
                {{-- <i class="far fa-circle nav-icon"></i> --}}
                <p>laporan penggunaan dana disetujui</p>
              </a>
            </li>
            <li class="nav-item">
              <a href="{{ route('laporan ditolak') }}" class="nav-link">
                {{-- <i class="far fa-circle nav-icon"></i> --}}
